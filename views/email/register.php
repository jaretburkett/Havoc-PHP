...
<div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
    ...
    <p>
        <a href="<?php echo $domain; ?>/confirm_email/<?php echo $hash; ?>/">
            CLICK HERE
        </a>
        to confirm your email address.
    </p>
    <p>Or, copy and paste this link into your browser.</p>
    <p><?php echo $domain; ?>/confirm_email/<?php echo $hash; ?></p>

    <p>Thank you for registering at <strong><?php echo $website_name; ?></strong>.</p>
